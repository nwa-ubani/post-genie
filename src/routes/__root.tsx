...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "AutoPost — Daily LinkedIn posts on autopilot" },
      { name: "description", content: "Daily written LinkedIn posts researched from live Google data and published for you, automatically." },
      { property: "og:title", content: "AutoPost — Daily LinkedIn posts on autopilot" },
      { name: "twitter:title", content: "AutoPost — Daily LinkedIn posts on autopilot" },
      { property: "og:description", content: "Daily written LinkedIn posts researched from live Google data and published for you, automatically." },
      { name: "twitter:description", content: "Daily written LinkedIn posts researched from live Google data and published for you, automatically." },
