...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "GrowNowNow researches your industry with live Google data and publishes daily LinkedIn posts for you, automatically." },
      { property: "og:site_name", content: "GrowNowNow" },
      { property: "og:title", content: "GrowNowNow — Daily LinkedIn posts on autopilot" },
      { name: "twitter:title", content: "GrowNowNow — Daily LinkedIn posts on autopilot" },
      ...
      { name: "twitter:description", content: "Live Google research plus AI drafting — a brand post and a personal post, published to LinkedIn every day." },
